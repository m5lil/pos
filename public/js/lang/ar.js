LANG = {
    ...
    'confirm_delete_variation': "سيتم حذف هذا النوع مع جميع قيمه.",
    ...
    'cancel': 'إلغاء',
    'ok': 'موافق',
    'view_stock_details': 'عرض المخزون لكل نوع',
    ...
    'tour_step5_content': 'إضافة منتجات - منتجات بسيطة أو متنوعة ، قم بإنشاء نماذج للمنتجات المتنوعة ، وتسميات الطباعة.',
    ...
    'tour_step7_content': 'بيع -> POS ، استخدم هذه الشاشة أثناء بيع المنتجات أو فواتير العملاء. حدد الموقع ، إضافة المنتجات وإنهاء البيع.',
